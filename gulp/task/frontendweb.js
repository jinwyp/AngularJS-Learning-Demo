...
var paths = {
    base: 'app/public/',
    client: {
        js : ['app/public/angulardemo/js/**/*.js'],
        //js2 : ['public/angulardemo/js/**/*.js', 'public/angularslide/js/**/*.js'],
        sass : ['app/public/angulardemo/css/sass/**/*.scss'],
        css : ['app/public/angulardemo/css/stylesheets/*.css'],
...
// Compass 文件的路径
var compassConfig = {
    css : 'app/public/angulardemo/css/stylesheets',
    sass : 'app/public/angulardemo/css/sass',
    image : 'app/public/angulardemo/css/images',
